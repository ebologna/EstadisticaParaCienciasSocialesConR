...
En otro ejemplo, si a la persona aleatoriamente seleccionada (por ejemplo, quien ocupa el lugar `r round(runif(1, 20,110),0)` en la lista de asistentes a un curso) se le pregunta
...
```{r dossacadas, fig.cap="Efectos de extraer una ficha sin reponerla o reponiéndola, sobre las condiciones que quedan para la segunda extracción.", fig.align='center', out.width='80%'}
...
```{r espaciobayes, fig.cap="Esquema de un evento A que puede suceder en intersección con varios eventos $B_{i}$ independientes entre sí", fig.align='center', out.width='80%'}
...
```{r tienenotiene, fig.cap="Solo dos eventos definen el espacio muestral", fig.align='center', out.width='80%'}
...
```{r intersposit, fig.cap="Intersecciones del evento A con $B_1$ y $B_2$", fig.align='center', out.width='80%'}
...
aux_table <- tibble::tribble(
  ~"", ~"Positivo", ~"Negativo", ~"",
  "Esquizofrénicas", "19000", "1000", "20000",
