...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Ubicación de la zona de rechazo de Ho para una prueba unilateral derecha a un nivel de significación del 5%"}
ggplot(data = data.frame(z = c(-4.4)), aes(z)) +
