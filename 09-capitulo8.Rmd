...
```{r variasnormales, fig.cap="Probabilidades acumuladas bajo la distribución normal para diferentes valores de $z$", fig.asp = 0.5, fig.width = 17, fig.align='center'}
...
```{r tmenor2, fig.cap="Área correspondiente a la probabilidad de hallar una variable con ditribución t con un grado de libertad por debajo de 2"}
